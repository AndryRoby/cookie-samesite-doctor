...
- Use the hosted tool at
  https://arling.sk/cookie-samesite-doctor/ freely, for any
  purpose, personal or commercial, at no cost.
- Read the source of `index.html` / `doctor-cookie.js` to understand
...
- Use the "Cookie Doctor" name, the ARLing s. r. o. name, or
